...
function Home(){
    ...
    return(
        <div class = "flex flex-col justify-center">
            ...
            <div className="flex">
                <div class = "absolute w-full h-full top-1/2 place-items-center font-bold text-shadow-2xs text-shadow-purple-600">
                    <h1 class = " text-yellow-500 text-5xl">Clue Chasers Wanted!</h1>
                    <h2 class = "text-yellow-500 ">Decode each clue uncovering the mysteries that lie ahead</h2>
                </div>
            ...
            <div class = "flex flex-col justify-evenly p-2 md:flex-row">
                <div class = "flex flex-col justify-evenly bg-purple-600 text-yellow-500 p-5 m-2 rounded md:w-100">
                    ...
                    <a className="text-purple-600 bg-yellow-500 rounded hover:cursor-pointer p-1 m-2" href = "/createHunt">Create Hunt</a>
                </div>
                <div class = "flex flex-col justify-evenly bg-purple-600 text-yellow-500 p-2 m-2 rounded md:w-100">
                    ...
                    <a className="text-purple-600 bg-yellow-500 rounded hover:cursor-pointer p-1 m-2" href = "/play">Play Hunt</a>
                </div>
                <div class = "flex flex-col justify-evenly bg-purple-600 text-yellow-500 p-5 m-2 rounded md:w-100">
                    <h2>Section 3</h2>
                    <img className = "h-screen w-screen object-cover" src = {editMap} alt = "edit page pic"></img>
                    <a className="text-purple-600 bg-yellow-500 rounded hover:cursor-pointer p-1 m-2" href = "/editHunt">Edit Hunt</a>
                </div>
            </div>
        </div>
    )
